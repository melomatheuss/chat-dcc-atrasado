            ...
            >
                ...
                <div>
                    <form onSubmit={handleJoin} className="flex gap-2">
                        ...
                        <button 
                            type='submit' 
                            className='bg-[#244254] hover:bg-[#355c74] text-white font-bold py-2 px-4  rounded'
                        >
                            {!showSpinner ? (
                                "Entrar"
                                ) : (
                                    <div className="bg-[#244254] hover:bg-[#355c74] text-white font-bold py-2 px-4 border-[#244254] rounded">
